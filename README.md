...
#### Голосовые команды (Алиса)

| Команда | Действие |
|---------|----------|
| «Алиса, выключи везде свет» | Активация Away Mode |
| «Алиса, покорми кошку» | Petkit → выдать порцию |
| «Алиса, сколько в детской градусов?» | HA читает датчик Яндекса |
| «Алиса, включи уборку» | Roborock → старт уборки |
| «Алиса, я ухожу» | Away Mode + Roborock |
...
| Сенсорные выключатели 2.4 ГГц | Туалет, коридор, ванная, гостиная, кухня, спальня |
...
|------------|--------------|-------------|
| Raspberry Pi 4 (8GB) | Коридор | Home Assistant OS + Mosquitto |
...
- Камеры Xiaomi иногда теряют связь через облако — планируется переход на локальный протокол
